...
class expresspay_cardpaymentModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$request_params = array(
							...
							'Info' => 'Оплата тована в магазине ' . Configuration::get('PS_SHOP_NAME')						
						);

		$request_params['Signature'] = $this->compute_signature_add_invoice($request_params, $config['send_secret_word']);
